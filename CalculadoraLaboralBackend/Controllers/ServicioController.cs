...
namespace CalculadoraLaboralBackend.Controllers
{
    ...
    public class ServicioController : Controller
    {
        ...
        {
            var servicio = await _context.Servicio.Where(i => i.Fk_ColaboradorId == tecnico && i.semanaDelAno == semanaDelAno).ToListAsync();
        ...
        public Servicio CrearServicioDiaSiguiente(Servicio servicio)
        {
            ...
            servicioDiaSiguiente.Fk_ColaboradorId = servicio.Fk_ColaboradorId;
        ...
        public Servicio CrearServicioNocturno(Servicio servicio)
        {
            ...
            servicioNocturno.Fk_ColaboradorId = servicio.Fk_ColaboradorId;
